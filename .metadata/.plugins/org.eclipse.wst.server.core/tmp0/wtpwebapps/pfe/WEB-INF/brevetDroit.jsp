...
<c:when test="${sessionScope.etatSession==true}">
    ...
    <c:if test="${reussit}">
		...
		<script type="text/javascript">
			alert("Brevet Droit a été déclarer!")
		</script>
	...
	<c:if test="${reussitmodification}">
		...
		<script type="text/javascript">
			alert("Brevet Droit a été Modifier!")
		</script>
								...
								<div>
                                    ...
                                    <div class="well">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="form-group">
                                               <label for="numeroDepot">Numéro de dépot<font color="red">*</font></label> <input type="text" name="numeroDepot" class="form-control"> 
                                            </div>
                                            <div class="form-group">
                                               <label for="dateDepot">Date de dépot<font color="red">*</font></label> <input type="date" name="dateDepot" class="form-control"> 
                                            </div>
                                            <div class="form-group">
                                               <label for="numeroEnregistrement">Numéro d'enregistrement</label> <input type="text" name="numeroEnregistrement" class="form-control" > 
                                            </div>
                                            <div class="form-group">
								...
								<form id="formBrevetDroit" class="form-horizontal" method="post" action="">
                                    ...
                                    <div class="well">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="form-group">
                                               <label for="numeroDepot">Numéro de dépot<font color="red">*</font></label> <input type="text" name="numeroDepot" class="form-control" value="${brevetdroit.numeroDepot }"> 
                                            </div>
                                            <div class="form-group">
                                               <label for="dateDepot">Date de dépot<font color="red">*</font></label> <input type="date" name="dateDepot" class="form-control" value="${brevetdroit.dateDepot }"> 
                                            </div>
                                            <div class="form-group">
                                               <label for="numeroEnregistrement">Numéro d'enregistrement</label> <input type="text" name="numeroEnregistrement" class="form-control"value="${brevetdroit.numeroEnregistrement }" > 
                                            </div>
                                            <div class="form-group">
                                                <button class="btn btn-success pull-right">Enregistrer</button>
                                            </div>
