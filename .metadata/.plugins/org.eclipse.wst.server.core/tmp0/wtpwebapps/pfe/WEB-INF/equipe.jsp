                                    ...
                                    <form id="formAjouter" class="form-horizontal" method="post" action="equipe">
											...
											<div class="well">
												<div class="form-group">
													<label for="nom">Nom d'équipe<font color="red">*</font></label>
												...
												<div class="col-sm-offset-3 col-sm-6 ">
													...
													<table class="table table-bordered">
														<tr>
															...
															<c:if test="${!empty utilisateur.grade}">
																<tr>
																	<td><input type="checkbox" name="enseignants" value="${utilisateur.login}"></td>
													...
													<table class="table table-bordered">
														<tr>
															...
															<c:if test="${!empty utilisateur.cne}">
																<tr>
																	<td><input type="checkbox" name="doctorants" value="${utilisateur.login}"></td>
																	<td>${utilisateur.nom}&nbsp${utilisateur.prenom}</td>
																</tr>
															</c:if>
														</c:forEach>
