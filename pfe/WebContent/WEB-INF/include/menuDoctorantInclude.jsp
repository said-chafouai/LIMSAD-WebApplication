            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="formationPersonnelle"><i class="fa fa-child fa-fw"></i> Formation personnelle</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="manifistation"><i class="fa  fa-maxcdn fa-fw"></i> Manifstation</a>
                        </li>
                        <li>
                            <a href="partenariatNonfinance"><i class="fa fa-paste  fa-fw"></i> Partenariat non financée</a>
                        </li>
                        <li>
