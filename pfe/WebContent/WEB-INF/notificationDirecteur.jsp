	...
	<c:choose>
		<c:when test="${sessionScope.etatSession==true}">
			...
			<div id="wrapper">
				...
				<!-- Les alertes de réussite ou succes -->
				
				<c:if test="${etat==true }">
					<script type="text/javascript" >alert("demande accepte");</script>
				</c:if>
				<c:if test="${etat==false}">
					<script type="text/javascript" >alert("malheureusement (-_-) on a pas pu envoyer l'email de validation merci de réessayer plus tard ");</script>
				</c:if> 
						...
						<div class="col-lg-12">
							...
							<div class="panel-body">
								...
								<ul class="nav nav-tabs  nav-justified">
									<li class="active"><a href="#indexe" data-toggle="tab">Nouvelle activité</a></li>
															...
															<table class="table table-bordered">
																...
																<c:forEach items="${ouvragesAttentes}"
																	...
																	<tr>
																		...
																		<td><a href="http://localhost:8181/pfe/fichiers/${ouvrageAttente.preuve}">Télécharger</a></td>						
															...
															<table class="table table-bordered table-condensed">
																...
																<c:forEach items="${brevetsDroitsAttentes}"
																	...
																	<tr>
																		...
																		<td><a href="http://localhost:8181/pfe/fichiers/${brevetDroit.preuve}">Télécharger</a></td>
																		<td><font color="red">En Attente</font></td>
																	</tr>
																</c:forEach>
															</table>
